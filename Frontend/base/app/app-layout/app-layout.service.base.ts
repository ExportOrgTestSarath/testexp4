...
export class AppLayoutBaseService {
  ...
  config : any = {"left":[{"outline":false,"infiniteScroll":false,"urlIconFileName":"Company Logo.svg","valueChange":true,"logoFileName":"Company Logo.svg","currentNode":"5286bc7f-f22b-4164-aafc-77c25693e64d","mobileLogoFileName":"Company Logo.svg","element":"logo"},{"outline":false,"menuType":"fixed","hideSidebarOnCollapse":false,"element":"leftMenu"},{"outline":false,"element":"appTitle"}],"middle":[{"outline":false,"element":"leftPane"},{"outline":false,"element":"middlePane"},{"outline":false,"element":"rightPane"}],"right":[{"children":[{"outline":false,"link":"/logout","label":"Logout","element":"logout"}],"element":"user"},{"outline":false,"menuType":"float","element":"rightMenu"}]};
